...
for ent_coef in np.round(np.logspace(1.2,1.7,num=5,base=10)/100,2):

    model_kwargs = {'n_steps': 64, 'ent_coef': ent_coef, 'learning_rate': 0.0001, 'batch_size': 32}
    external_info = f"r{r_negative_minus}rr{rr_positive_mul}hr{hr_mul}_ec{int(ent_coef*100)}"
